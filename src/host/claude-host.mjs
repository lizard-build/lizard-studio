...
// spawning" there for why this exists. argv: <port> <token> <spawnId>
import net from "node:net";
...
class DetachedClaude extends EventEmitter {
  constructor(cmd, args, opts) {
    ...
    execFile(
      "launchctl",
      ["submit", "-l", this._label, "--", NODE, SHIM_PATH, String(spawnPort), SPAWN_TOKEN, this._spawnId],
      (err) => {
